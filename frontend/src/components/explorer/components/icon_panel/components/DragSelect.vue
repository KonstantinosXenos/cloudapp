    ...
    computed: {
      ...
      var scrollDifferenceSinceClick=scroll.y-this.scrollatstart.y
        if ((this.startPoint.y- scrollDifferenceSinceClick)<=this.endPoint.y){
            top=this.startPoint.y + scroll.y - scrollDifferenceSinceClick - clientRect.top 
            height = Math.abs(this.startPoint.y - this.endPoint.y - scrollDifferenceSinceClick)
      
        }
        else {
            top=this.endPoint.y + scroll.y - clientRect.top 
       
            height = Math.abs(this.endPoint.y - this.startPoint.y + scrollDifferenceSinceClick) 
            console.log(scrollDifferenceSinceClick)
        }
